...
public class Market_Cards extends Card {
	public Market_Cards(String title, String type, Boolean effect, int value) {
	...
	Card Profit1 = new Card("Small Business Boom!", "profit", True, 250);
	...
	Card Profit2 = new Card("New Management System", "profit", False, 400);
	...
	Card Gold1 = new Card("Price of Gold Soars", "gold", True, 2000);
	...
	Card Gold2 = new Card("Collector wants Gold Coins", "gold", True, 1000);
	...
	Card Gold3 = new Card("Price of Gold Soars", "gold", True, 1000);
	...
	Card Gold4 = new Card("Collector wants Gold Coins", "gold", True, 500);
	...
	Card Expense1 = new Card("Sewer Line Breaks", "expense", False, 1000);
	...
	Card Expense2 = new Card("Sewer Line Breaks", "expense", False, 2000);
	...
	Card Expense3 = new Card("Tenant Damages Your Property", "expense", False, 500);
	...
	Card Expense4 = new Card("Tenant Damages Your Property", "expense", False, 500);
	//Tenant refuses to pay rent. After the tenant has been evicted, you discover significant damage to your property. Insurance covers most repairs, but you still must pay $500(one time). Take out a bank loan if necessary to cover these expenses. Card applies only to the person who drew it. If you own NO real estate, ignore this card.
	Card Expense5 = new Card("Tenant Damages Your Property", "expense", False, 1000;
	...
	Card Stock1 = new Card("Stock - MYT4U Electronics Co.","stock",True,0);
	...
	Card Stock2 = new Card("Stock - GRO4US Fund","stock",True,0);
	...
	Card Stock3 = new Card("Stock - ON2U Entertainment Co.","stock",True,0);
	...
	Card Stock4 = new Card("Stock - OK4U Drug Co.","stock",True,0);
	...
	Card REPercent1 = new Card("House Buyer - 3BR/2BA","repercent",True,110);
	...
	Card REPercent2 = new Card("House Buyer - 2BR/1BA","repercent",True,110);
	...
	Card REPercent3 = new Card("House Buyer - 3BR/2BA","repercent",True,120);
	...
	Card REPercent4 = new Card("House Buyer - 2BR/1BA","repercent",True,120);
	...
	Card REPercent5 = new Card("House Buyer - 3BR/2BA","repercent",True,115);
	...
	Card REPercent6 = new Card("Plex Buyer","repercent",True,110);
	...
	Card REPercent7 = new Card("Plex Buyer","repercent",True,105);
	...
	Card REPercent8 = new Card("Plex Buyer","repercent",True,115);
	...
	Card REPercent9 = new Card("Plex Buyer","repercent",True,120);
	...
	Card REFixed1 = new Card("House Buyer - 3BR/2BA","refixed",True,15000);
	...
	Card REFixed2 = new Card("House Buyer - 3BR/2BA","refixed",True,1000);
	...
	Card REFixed3 = new Card("House Buyer - 3BR/2BA","refixed",True,20000);
	...
	Card REFixed4 = new Card("House Buyer - 3BR/2BA","refixed",True,5000);
	...
	Card REHOffer1 = new Card("House or Condo Buyer - 2BR/1BA","hoffer",True,45000);
	...
	Card REHOffer2 = new Card("House or Condo Buyer - 2BR/1BA","hoffer",True,65000);
	...
	Card REFixed5 = new Card("Plex Buyer","refixed",True,1000);
	...
	Card REFixed6 = new Card("Plex Buyer","refixed",True,30000);
	...
	Card REFixed7 = new Card("Plex Buyer","refixed",True,15000);
	...
	Card REFixed8 = new Card("Plex Buyer","refixed",True,5000);
	...
	Card REFixed9 = new Card("Plex Buyer","refixed",True,1000);
	//Buyer looking for all Apartment and Plexes in any combination of units. Offers your original cost plus $1,000. Everyone may sell any number of properties at this price. If you sell, pay off the related mortgage and give up the cash flow on this property.
	Card REFixed10 = new Card("Plex Buyer","refixed",True,20000);
	...
	Card REFixed11 = new Card("Plex Buyer","refixed",True,10000);
	...
	Card REAOffer1 = new Card("Apartment House Buyer","aoffer",True,25000);
	...
	Card REAOffer2 = new Card("Apartment House Buyer","aoffer",True,45000);
	...
	Card REAOffer3 = new Card("Apartment House Buyer","aoffer",True,30000);
	...
	Card REAOffer4 = new Card("Apartment House Buyer","aoffer",True,40000);
